window.BHB_SEED_DATA = {
  ...
  "heroSlides": [
    ...
    },
    {
      ...
      "lead": "Equipping adolescent girls with disabilities, widows, and vulnerable youth with healthcare access, digital literacy, and economic self-reliance across underserved communities.",
      "image": "",
      "primaryCtaText": "Partner With Us →",
      "primaryCtaLink": "contact.html",
  ...
  "focusAreas": [
    {
      ...
      "summary": "We educate and empower girls in secondary schools on menstrual health and hygiene, while providing sanitary pads and essential hygiene supplies. Our goal is to ensure that every girl can manage her period safely, comfortably, and with dignity, free from shame, stigma, or missing school.",
      "image": "",
    ...
    },
    {
      ...
      "summary": "Delivering intensive digital literacy boot camps, assistive screen-reader computing, and hardware grants for young women living with visual and physical impairments across underserved communities.",
      "image": "",
  ...
  "projects": [
    {
      ...
      "location": "Regional Innovation Hub",
    ...
    {
      "id": "proj-4",
      "title": "Youth Technical & Apprenticeship Hub",
      "category": "Youth Mentorship",
      "location": "Vocational Development Centre",
    ...
    },
    {
      ...
      "category": "Digital Inclusion",
      "location": "Central Innovation Campus",
  ...
  "posts": [
    {
      "id": "post-1",
      "title": "Breaking Barriers: How 10 Young Girls with Disabilities Mastered Coding",
      "category": "Digital Inclusion",
      "author": "Malam Ibrahim Al-Hassan",
      "authorRole": "Director of Programs & Inclusive Tech",
      "date": "August 18, 2026",
      "readTime": "4 min read",
      "tags": ["InclusiveTech", "DisabilityAdvocacy", "YouthEmpowerment"],
      "image": "",
    ...
    {
      "id": "post-2",
      "title": "Closing the Maternal Health Gap: Expanding Mobile Primary Care in Rural Settlements",
      "category": "Health & Maternal Care",
      "author": "Dr. Aisha Kwaku",
      "authorRole": "Lead Strategic Health Advisor",
      "date": "August 12, 2026",
      "readTime": "5 min read",
      "tags": ["MaternalHealth", "MobileClinics", "PrimaryCare"],
      "image": "",
    ...
    },
    {
      ...
      "image": "",
      "excerpt": "Fatima, a widowed mother of four, transformed her family's future through business training and seed capital.",
  ...
  "comments": [
    {
      "id": "comm-1",
      "postId": "post-1",
      "postTitle": "Breaking Barriers: How 10 Young Girls with Disabilities Mastered Coding",
      "authorName": "Dr. Fatima Al-Mansoor",
      "authorEmail": "f.almansoor@education.org",
      "content": "This is a truly transformative initiative. Digital literacy for adolescent girls with disabilities addresses one of the most overlooked sectors of inclusive development.",
      "date": "August 19, 2026",
      "status": "approved"
    },
    {
      ...
      "content": "Proud to see grassroots organizations partnering with Ability First. Looking forward to cohort 2 expansion across other communities.",
      "date": "August 20, 2026",
      "status": "approved"
    },
    {
      "id": "comm-3",
      "postId": "post-2",
      "postTitle": "Closing the Maternal Health Gap: Expanding Mobile Primary Care in Rural Settlements",
  ...
  "team": [
    {
      ...
      "order": 1,
      "published": true,
      "bio": "Dr. Bashir established BHB Foundation to advance human dignity, social resilience, and structured opportunity across underserved communities.",
      "image": ""
    },
    {
      "id": "team-2",
      ...
      "order": 2,
      "published": true,
      "bio": "Fatima leads the foundation's strategic direction, partner alignment, and programme execution across participating communities and partner regions.",
      "image": ""
    },
    {
      "id": "team-3",
    ...
    },
    {
      ...
      "order": 5,
      "published": true,
      "bio": "Coordinates ground logistics, community liaison town halls, and resource delivery across all target communities and operational field sites.",
      "image": ""
    },
    {
      "id": "team-6",
